...
-- During Lua reset / connect-to-server, `BanditCreator` may not be initialized yet.
BanditCreator = BanditCreator or {}
BanditCreator.GroupMap = BanditCreator.GroupMap or {}
-- Keep compatibility with code that expects `ClanMap` (alias of GroupMap).
BanditCreator.ClanMap = BanditCreator.GroupMap
